  ...
  return (
    <div>
      <div className="">
        ...
        <div data-aos="fade-down" className="flex flex-col justify-center items-center rounded-xl shadow-2xl bg-white w-11/12 mx-auto -mt-13 py-15 relative z-5">
          ...
          <div className="w-sm mt-8">
            <div className="">
              ...
              <input
                ...
                className="mt-2 shadow rounded focus:: outline-1 outline-gray-400 py-2 px-4 w-full"
              />
            </div>
            <div className="mt-5">
